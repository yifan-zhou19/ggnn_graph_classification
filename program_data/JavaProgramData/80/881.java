...
public class GlobalMembers
{
	public static int Main()
	{
		...
		int tm;
		int td;
		oy = Integer.parseInt(ConsoleInput.readToWhiteSpace(true));
		om = Integer.parseInt(ConsoleInput.readToWhiteSpace(true));
		od = Integer.parseInt(ConsoleInput.readToWhiteSpace(true));
		ty = Integer.parseInt(ConsoleInput.readToWhiteSpace(true));
		tm = Integer.parseInt(ConsoleInput.readToWhiteSpace(true));
		td = Integer.parseInt(ConsoleInput.readToWhiteSpace(true));
