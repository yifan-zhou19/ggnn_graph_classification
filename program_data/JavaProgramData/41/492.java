...
{
	public static int checka(int E)
	{
		if (E == 1)
		{
			return 1;
	...
	public static int checkc(int A)
	{
		if (A == 5)
		{
			return 1;
	...
	public static int checkd(int C)
	{
		if (C != 1)
		{
			return 1;
	...
	public static int checke(int D)
	{
		if (D == 1)
		{
			return 1;
	...
	{
		air[] p = tangible.Arrays.initializeWithDefaultairInstances(5);
