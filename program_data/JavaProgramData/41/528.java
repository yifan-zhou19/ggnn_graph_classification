...
{
	public static int aa(int a,int b,int c,int d,int e)
	{
		int p;
		if (e == 1)
		{
	...
	public static int cc(int a,int b,int c,int d,int e)
	{
		int p;
		if (a == 5)
		{
	...
	public static int dd(int a,int b,int c,int d,int e)
	{
		int p;
		if (c != 1)
		{
	...
	public static int ee(int a,int b,int c,int d,int e)
	{
		int p;
		if (d == 1)
		{
