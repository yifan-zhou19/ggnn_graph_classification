	...
	public static int Main()
	{
		...
		for (i = 0;i < l;i++)
		{
			if (zfc.charAt(i) == '-')
			{
				...
				for (k = i + 1;k < l;k++)
				{
					if ((zfc.charAt(k) == '1') || (zfc.charAt(k) == '2') || (zfc.charAt(k) == '3') || (zfc.charAt(k) == '4') || (zfc.charAt(k) == '5') || (zfc.charAt(k) == '6') || (zfc.charAt(k) == '7') || (zfc.charAt(k) == '8') || (zfc.charAt(k) == '9') || (zfc.charAt(k) == '0'))
					{
						i++;
					}
					else
