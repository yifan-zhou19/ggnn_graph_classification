...
public class GlobalMembers
{
	public static int Main()
	{
		...
		{
			int[][] a = new int[m][m];
			for (j = 0;j < m;j++) //&Ntilde;&shy;&raquo;�&Ecirc;&auml;&Egrave;&euml;&frac34;&Oslash;&Otilde;�
			{
			for (k = 0;k < m;k++)
			{
			...
			sum = 0;
			for (n = m;n > 1;n--) //&frac34;&Oslash;&Otilde;�&sup1;�&Aacute;&atilde;
			{
			...
			for (k = 0;k < n;k++) //&Aacute;&ETH;&sup1;�&Aacute;&atilde;
			{
				min = a[0][k];
				for (j = 1;j < n;j++)
				{
			...
			for (j = 1;j < n - 1;j++) //&frac34;&Oslash;&Otilde;�&Iuml;&ucirc;&frac14;&otilde;
			{
			for (k = 0;k < n;k++)
			{
