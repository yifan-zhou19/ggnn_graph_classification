	...
	public static void Main(String[] args)
	{
		...
		for (i = 0;i < m;i++)
		{
			for (j = 0;j < n;j++)
			{
				...
				if (i == 0 && j > 0 && j < n - 1 && a[i][j] >= a[i][j + 1] != 0 && a[i][j] >= a[i][j - 1] != 0 && a[i][j] >= a[i + 1][j])
				{
					System.out.printf("%d %d\n",i,j);
				}
				...
				if (i > 0 && i < m - 1 && j>0 && j < n - 1 && a[i][j] >= a[i][j + 1] != 0 && a[i][j] >= a[i + 1][j] != 0 && a[i][j] >= a[i - 1][j] != 0 && a[i][j] >= a[i][j - 1])
				{
					System.out.printf("%d %d\n",i,j);
				}
				...
				if (i == m - 1 && j > 0 && j < n - 1 && a[i][j] >= a[i][j + 1] != 0 && a[i][j] >= a[i][j - 1] != 0 && a[i][j] >= a[i - 1][j])
				{
					System.out.printf("%d %d\n",i,j);
				}
