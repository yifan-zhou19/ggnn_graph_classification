...
public class GlobalMembers
{
	...
	public static int plu(int n, int add)
	{
		if (n == 0)
		{
			...
			{
				c = tangible.StringFunctions.changeCharacter(c, 0, a.charAt(0) + b.charAt(0) + add - 58);
				for (i = len3;i >= 1;i--)
				{
			...
			{
				c = tangible.StringFunctions.changeCharacter(c, 0, a.charAt(0) + b.charAt(0) + add - 48);
			}
		}
		else
		{
