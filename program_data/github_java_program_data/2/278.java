...
class Skiplist {
	...
	public void insert(int key) {
		...
		// Der key-Knoten soll nur eingef�gt werden wenn er nicht schon
		// existiert
		if (!search(key)) {
	...
	//funktion zur berechnung wie oft der key-Knoten eingef�gt werden soll
	public int rollDice() {
		int counter = 0;
	...
	public static void main(String[] args) {
		...
		System.out.println("Jetzt wird gel�scht");
		//Aufgabenteil b
