 ...
 */
public final class JavaLogisticRegression {

	private static final int D = 16; // Number of dimensions
	...
	public static void main(String[] args) {
		...
		if (args.length < 2) {
			System.err.println("Usage: JavaLogisticRegression <file> <iters>");
			System.exit(1);
		}

		SparkConf sparkConf = new SparkConf()
				.setAppName("JavaLogisticRegression");
